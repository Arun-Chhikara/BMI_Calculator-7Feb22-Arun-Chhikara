...
class BMI:
    ...
    a>. Use profile_bmi method to calculate the BMI of persons and also count of overweight persions
    b>. profile_bmi ouputs a tuble of a pandas dataframe and in integer. 
